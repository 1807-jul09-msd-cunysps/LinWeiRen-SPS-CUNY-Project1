...
function formValidation() {
    debugger;
    var pass = true;
    var fields = ["#firstName", "#lastName", "#age", "input[name='gender']", "#address1", "#address2", "#city",
...
function convertJson() {
    var fields = ["#firstName", "#lastName", "#address1", "#address2", "#city",
        "#state", "#country","#countryCode","#zipcode", "#areaCode", "#phone", "#email"];
    var jsObjct = {}; 
